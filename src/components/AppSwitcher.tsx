...
function AppGlyph({
  ...
  return (
    <span className="relative inline-flex shrink-0">
      <ProviderIcon icon={APP_ICON_NAME[app]} name={name} size={20} />
      {BadgeIcon && (
        <span
          className={cn(
    ...
    >
      {visibleList.map((app) => {
        ...
        return (
          ...
          >
            <AppGlyph app={app} name={appDisplayName(app)} isActive={isActive} />
          </button>
        );
      })}
        ...
        <Popover open={moreOpen} onOpenChange={setMoreOpen}>
          ...
          >
            {overflowList.map((app) => (
              ...
              >
                <AppGlyph app={app} name={appDisplayName(app)} isActive={false} />
